        ...
        <form onSubmit={handleSubmit(onSubmit)} className="form">
          ...
          <div className="form_item">
            <input
              className="form_item-input"
              style={{
                borderStyle: formState?.errors?.MobileNumber
                  ? "dotted"
                  : "solid",
              }}
              type="tel"
          ...
          <div className="form_item">
            <input
              className="form_item-input"
              style={{
                borderStyle: formState?.errors?.Email ? "dotted" : "solid",
              }}
              type="text"
              placeholder="E-mail"
              {...register("Email", {
          ...
          <button
            ...
            onClick={() => {
              active
                ? window.ym(90054720, "reachGoal", "form1-submint")
                : window.ym(90054720, "reachGoal", "form2-submint");
            }}
          >
            Отправить
          </button>
